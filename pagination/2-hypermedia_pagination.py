...
class Server:
    ...
    def get_hyper(self, page: int = 1, page_size: int = 10) -> dict:
        """
        Retourne les métadonnées de pagination hypermédia ainsi
        que le contenu de la page

        Clés :
        - page_size : nombre réel d’éléments renvoyés pour cette page
        - page : numéro de la page courante
        - data : liste des lignes pour la page demandée
